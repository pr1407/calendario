            ...
            <form action="" class="col s4" id="Cuadroleft">
                <div class="row card-panel Cuadro">
                    ...
                    <ul class="collapsible">
                        <h5>Tareas</h5>
                        <li>
                            <div class="collapsible-header"><i class="material-icons">filter_drama</i>Hoy</div>
                        ...
                        <li>
                            <div class="collapsible-header"><i class="material-icons">filter_drama</i>Mañana</div>
                            <div class="collapsible-body">
                                <ul class="collapsible">
                                    <li>
                                        <div class="collapsible-header"><i class="material-icons">book</i>Tarea 1</div>
                        ...
                        <li>
                            <div class="collapsible-header"><i class="material-icons">filter_drama</i>Proxima Semana</div>
                            <div class="collapsible-body">
                                <ul class="collapsible">
                                    <li>
                                        <div class="collapsible-header"><i class="material-icons">book</i>Tarea 1</div>
