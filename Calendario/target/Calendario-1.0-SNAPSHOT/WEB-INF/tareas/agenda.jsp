...
<html>
    ...
    <body>
        ...
        <div class="section container" id="principal">
            <div class="row" >
                <form action="" class="col m4" id="Cuadroleft">
                    <div class="row card-panel Cuadro">


                        <ul class="collapsible">
                            <h4> Tarea Pendiente</h4>
                            <a class="btn-floating btn-small waves-effect waves-light dark"><i class="material-icons">add</i></a>
                            <li>
                ...
                <form action="" class="col m7">
                    <div class="row card-panel Cuadro">
                        <h5>Calendario Google</h5>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam rerum sint deserunt ratione harum aliquam beatae voluptates,
                             vel placeat sapiente magni at laboriosam nemo ducimus adipisci omnis minima. Illo, qui.</p>
                    </div>
                </form>
        </div>
